...
> This document preserves the detailed Week 1–3 development record that previously served as the main project README. For current installation, usage, contribution, and release information, refer to the repository's main `README.md`.
