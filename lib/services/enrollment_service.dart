...
class EnrollmentService extends ChangeNotifier {
  ...
  final List<Map<String, String>> _pendingRequests = [
    {
      ...
      'name': 'Michael Scott',
      'date': 'Today, 9:00 AM',
      'reason': 'I want to upskill my team management.',
    },
    {
      'id': 'req_2',
      'program': 'Advanced Figma Prototyping',
      'name': 'Dwight Schrute',
      'date': 'Yesterday, 2:30 PM',
      'reason': 'Assistant to the Regional Manager.',
    },
    {
      'id': 'req_3',
      'program': 'User Research Fundamentals',
      'name': 'Jim Halpert',
      'date': 'Oct 12, 10:15 AM',
      'reason': 'Looking to learn new skills.',
    },
  ];
  ...
  EnrollmentStatus getStatus(String programTitle) {
    return _programStatus[programTitle] ??
        EnrollmentStatus.notApplied;
  }
  ...
  Future<void> submitApplication({
    ...
    // Simulates submitting data to a backend
    ...
    NotificationService.instance.addAdminNotification(
      ...
      content:
          'Current Learner has applied to join "$programTitle". Approve or reject this request in the Program Manager.',
    );
  ...
  void acceptRequest(
    ...
    if (learnerName == 'Current Learner') {
      ...
      NotificationService.instance.addLearnerNotification(
        ...
        content:
            'Your enrollment for "$programTitle" has been granted! You can now start learning.',
      );
    }
  ...
  void declineRequest(
    ...
    if (learnerName == 'Current Learner') {
      ...
      NotificationService.instance.addLearnerNotification(
        ...
        content:
            'Unfortunately, your application for "$programTitle" was not approved at this time.',
      );
    }
