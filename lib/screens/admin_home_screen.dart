              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    onPressed: () async {
                      final bool confirmed = await showLogoutConfirmationDialog(
                        sheetContext,
                      );
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(icon, size: 19, color: const Color(0xFF6F7989)),
              const Spacer(),
              Container(
...
class _AnnouncementModalFormState extends State<_AnnouncementModalForm> {
  ...
  void _postAnnouncement() {
    if (_titleController.text.trim().isEmpty ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please fill out the title and description.'),
        ),
      );
      return;
    }
      ...
      child: Column(
        ...
        children: [
          ...
          OutlinedButton.icon(
            ...
            label: Text(
              _hasMockImage ? 'Image Attached' : 'Upload Image/Resource',
            ),
            style: OutlinedButton.styleFrom(
